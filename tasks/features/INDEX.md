# Open Features — Priority Queue

> Completed features → `tasks/features/completed/`  
> **Do NOT scan completed/ when looking for next task — everything actionable is here.**

| ID | Priority | Title | Est. | Decision needed? | File |
|---|---|---|---|---|---|
| FEAT-004 | 🔴 P1 | Payment integration ₹79/month (Phase 1: WhatsApp; Phase 2: Razorpay) | 1–2 sessions | ✅ Yes — processor + trial days + plan storage | [→](FEAT-004-payment-integration.md) |
| FEAT-003 | 🔴 P1 | Lazy loading — only load Daily Sprint on sign-in | 0.5 session | No | [→](FEAT-003-lazy-subject-tab-loading.md) |
